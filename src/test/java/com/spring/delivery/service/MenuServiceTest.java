...
class MenuServiceTest {
    ...
    void applyMenuPolicy() {
        MenuRegisterDTO menuRegisterDTO = new MenuRegisterDTO("마라싸이버거", "main", 7000, "이 햄버거는 무척 맛있다",
                "image001", 15L);
        menuService.create(menuRegisterDTO);
        MenuDiscountPolicyDTO menuDiscountPolicyDTO = new MenuDiscountPolicyDTO("마라싸이버거", "percentage");
